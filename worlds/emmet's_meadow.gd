...
func setup_seed_totals():
	$CursorCamera/ToolBelt/Seeds_Menu/Sunflower_Total.text = "%02d" % seeds[0]
	$CursorCamera/ToolBelt/Seeds_Menu/Carrot_Total.text = "%02d" % seeds[1]
	$CursorCamera/ToolBelt/Seeds_Menu/Blueberry_Total.text = "%02d" % seeds[2]
	$CursorCamera/ToolBelt/Seeds_Menu/Apple_Total.text = "%02d" % seeds[3]
	$CursorCamera/ToolBelt/Seeds_Menu/Poppy_Total.text = "%02d" % seeds[4]
...
func _get_animal_by_plant_id(plantID: int):
	if plantID == 0:
		...
		# Currently for testing, if no animal is selected for a plant, a deer will be spawned
		return deer_instance
